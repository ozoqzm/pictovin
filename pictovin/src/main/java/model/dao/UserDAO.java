...
public class UserDAO {
	...
	public int create(User user) throws SQLException {
		...
		Object[] param = new Object[] {user.getUserId(), user.getName(), user.getPassword(), user.getEmail()};				
	 ...
	 * 기존의 사용자 정보를 수정.
	 */
	public int update(String userId, String name, String email) throws SQLException {
		String sql = "UPDATE USERINFO "
					+ "SET userName=?, email=? "
					+ "WHERE userId=?";
		Object[] param = new Object[] {name, email, userId};				
